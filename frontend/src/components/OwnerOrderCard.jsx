    ...
    return (
        <div className='bg-white rounded-lg shadow p-4 space-y-4'>
            <div>
                ...
                <p className='flex items-center gap-2 text-sm text-gray-500'><MdOutlineMailOutline /><span>{data.user.email}</span></p>
            ...
            <div className='flex justify-between items-center mt-auto pt-3 border-t border-gray-100'>
                ...
                focus:ring-2 border-[#ff4d2d] text-[#ff4d2d]' onChange={(e) => handleUpdateStatus(data._id, data.shopOrders.shop._id, e.target.value)}>
