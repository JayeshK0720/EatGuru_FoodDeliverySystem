...
const UserDashboard = () => {
  ...
  const updateButton = (ref, setLeftButton, setRightButton) => {
    ...
    if (element) {
      ...
      setRightButton(element.clientWidth + element.scrollLeft < element.scrollWidth)
    }
  }
  ...
  useEffect(() => {
    ...
    return () => {
      if(cateScrollRef.current){cateScrollRef?.current?.removeEventListener("scroll", null)}
      if(shopScrollRef.current){shopScrollRef?.current?.removeEventListener("scroll", null)}
    }
    ...
    gap-5 items-center bg-[#fff9f6] overflow-y-auto'>
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        <div className='w-full relative'>
          ...
          text-white p-2 rounded-full shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(cateScrollRef, "left")}>
            <FaCircleChevronLeft />
          </button>}
          ...
          text-white p-2 rounded-full shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(cateScrollRef, "right")}>
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        <div className='w-full relative'>
          ...
          text-white p-2 rounded-full shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(shopScrollRef, "left")}>
            <FaCircleChevronLeft />
          </button>}
          ...
          text-white p-2 rounded-full shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(shopScrollRef, "right")}>
            <FaCircleChevronRight />
          </button>}
        </div>
      </div>
