    ...
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center '>
        ...
        border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                Join our food delivery platform and reach
                thousands of hungry customers every day.
              </p>
              <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full 
              font-medium shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer'
                onClick={() => {
      ...
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          mt-8 text-center'><FaUtensils className='text-[#ff4d2d] w-14 h-14' />Welcome to {myShopData.name}</h1>
          ...
          hover:shadow-2xl transition-all duration-300 w-full max-w-2xl relative'>
            ...
            <div className='p-4 sm:p-6'>
              <h1 className='text-xl sm:text-2xl font-bold'>{myShopData.name}</h1>
        ...
        border-gray-100 hover:shadow-xl transition-shadow duration-300'>
              <div className='flex flex-col items-center text-center'>
                ...
                <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                  Share your delicious creations with our customers
                  by adding them to the menu.
                </p>
                <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full 
              font-medium shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer'
                  onClick={() => {
