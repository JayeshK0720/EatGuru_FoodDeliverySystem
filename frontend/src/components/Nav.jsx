...
const Nav = () => {
  ...
  return (
    ...
    overflow-visible'>
      ...
      {showSearch && userData.role == "user" && <div className='w-[90%] h-[70px] bg-white shadow-xl rounded-lg
      ...
      <h1 className='text-3xl font-bold mb-2 text-[#ff4d2d]'>EatGuru</h1>
      {userData.role == "user" && <div className='md:w-[60%] lg:w-[40%] h-[70px] bg-white shadow-xl rounded-lg
      ...
      <div className='flex items-center gap-4'>
        {userData.role == "user" && (showSearch ? <RxCross2 size={25} className='text-[#ff4d2d] md:hidden'
          onClick={() => setShowSearch(false)} /> : <IoIosSearch size={25} className='text-[#ff4d2d] md:hidden'
        ...
        {userData.role == "owner" ? <>
          ...
          rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium' onClick={() => navigate("/my-orders")}>
            ...
            text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]'>0</span>
          </div>
        ...
        text-[#ff4d2d] text-sm font-medium cursor-pointer' onClick={() => navigate("/my-orders")}>
              My Orders
            </button>
          </>
        )}
        ...
        bg-[#ff4d2d] text-white text-[18px] shadow-xl font-semibold cursor-pointer' onClick={() => setShowInfo(prev => !prev)}>
          {userData?.fullName?.slice(0, 1)}
        </div>
        {showInfo && <div className={`fixed top-[80px] right-[10px] 
        ${userData.role == "deliveryBoy" ? "md:right-[20%] lg:right-[35%]" : "md:right-[10%] lg:right-[15%]"} w-[180px] bg-white
