  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center p-4'
      ...
      <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
        ...
        <h1 className={`text-3xl font-bold mb-2`} style={{ color: primaryColor }}>EatGuru</h1>
        ...
        <div className='mb-4'>
          ...
          <input type='tel' className='w-full border rounded-lg px-3 py-2 focus:outline-none' placeholder='Enter your Mobile No.'
            style={{ border: `1px solid ${borderColor}` }} onChange={(e) => setMobile(e.target.value)} value={mobile} required/>
        </div>
        ...
        <p className='w-full mt-4 flex items-center justify-center'> or </p>

        <button className='w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2 
        transition cursor-pointer duration-200 border-gray-400 hover:bg-gray-100' onClick={handleGoogleAuth}>
          <FcGoogle size={20} />
