...
const CreateEditShop = () => {
  ...
  return (
    ...
    bg-gradient-to-br from-orange-50 relative to-white min-h-screen'>
      ...
      <div className='max-w-lg w-full bg-white shadow-xl 
        rounded-2xl p-8 border border-orange-100'>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            {frontendImage && <div className='mt-4'>
              <img src={frontendImage} alt="" className='w-full h-48 
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
              ...
              <input type='text' placeholder='Enter Shop City' className='w-full px-4 py-2
              border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
            ...
            <div>
              ...
              <input type='text' placeholder='Enter Shop State' className='w-full px-4 py-2
              border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
          ...
          <button type='submit' className='w-full bg-[#ff4d2d] text-white px-6 py-3 rounded-lg
          font-semibold shadow-md hover:bg-orange-600 hover:shadow-lg 
