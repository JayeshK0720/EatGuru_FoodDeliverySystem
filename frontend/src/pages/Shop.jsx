...
function Shop() {
    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            <button className='absolute top-4 z-20 flex items-center gap-2
            bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full 
            shadow transition' onClick={() => navigate("/")}>
                <FaArrowLeft />
                <span>Back</span>
            </button>
                ...
                flex flex-col justify-center items-center text-center px-4'>
                    ...
                    drop-shadow-lg'>{shop.name}</h1>
                        <div className='flex items-center gap-[10px]'>
                            <FaLocationDot size={22} color='red' className='mt-2' />
